...
@Controller('track')
export class TrackController extends EntityController<TrackEntity, TrackDto, TrackDto>{
  ...
  @Put(':id')
  async update(@Param('id', ParseUUIDPipe) id: string, @Body() updateDto: TrackDto) {
